...
class FPN(BaseModule):
    ...
    def forward(self, inputs):
        ...
        #         laterals[i - 1] = laterals[i - 1]+self.lateral1_convs[used_backbone_levels-1-i](torch.cat((laterals[i - 1],self.up_convs[used_backbone_levels-1-i](laterals[i])),1))
        #     else:
